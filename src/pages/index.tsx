  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Experience the Power of Efficiency with Restaurant Booking Engine - Simplifying Table Reservations and Menu Management for Restaurants and Customers Alike"
        />
      </Head>
      <ConfigureCodeBanner
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Experience the Power of Efficiency with Restaurant Booking Engine - Simplifying Table Reservations and Menu Management for Restaurants and Customers Alike`}
            </Text>
            <Box
